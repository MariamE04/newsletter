...
public class MyConnectionPool {
    ...
    private static volatile MyConnectionPool instance = null;
    private static HikariDataSource ds = null;
    private static final Logger LOGGER = Logger.getLogger(MyConnectionPool.class.getName());
     ...
     */
    public static MyConnectionPool getInstance(String user, String password, String url, String db) {
        if (instance == null) {
